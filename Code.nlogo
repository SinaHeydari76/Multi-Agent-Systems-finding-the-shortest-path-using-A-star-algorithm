...
to setup
  ...
  ; storing it in a list that each cab own called:
  ; cab-pass-dist
...
; Calculate distances between passengers and their destinations


; Set up street layout
